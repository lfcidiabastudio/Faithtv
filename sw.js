...
const STATIC=["./","./index.html","./install.html","./styles.css","./app.js","./config.js","./frontend-content.js","./manifest.webmanifest","./faithtv-logo.png","./winners-cropped.svg","./winners-white-cropped.svg","./icon-192.png","./icon-512.png","./icon-maskable-512.png"];
